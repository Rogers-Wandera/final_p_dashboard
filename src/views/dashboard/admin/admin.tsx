...
const Admin = () => {
  ...
  function permissiondeleted(index: any) {
  ...
  function roledeleted(index: any) {
    role.splice(index, 1);
  }
  function roleedit(rolename: any, openmodal: any, roleid: any) {
    setShow3(openmodal);
            ...
            <Card.Body>
              <div className="table-responsive">
                ...
                <div className="text-center">
                  <Button
                    onClick={() => history("/dashboard/admin/admin")}
                    type="button"
                    variant="primary"
                  >
                    Save
