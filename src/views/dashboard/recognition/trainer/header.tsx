...
function HeaderTrainer({ setType, setEventKey }: headertrainerprops) {
          ...
          <Card.Body>
            <div className="d-flex flex-wrap align-items-center justify-content-between">
              ...
              >
                ...
                >
                  <Nav.Link eventKey="first">Image Trainer</Nav.Link>
                </Nav.Item>
                <Nav.Item
                  as="li"
                  onClick={() => {
                ...
                >
                  <Nav.Link eventKey="second">Audio Trainer</Nav.Link>
                </Nav.Item>
                {/* <Nav.Item as="li">
